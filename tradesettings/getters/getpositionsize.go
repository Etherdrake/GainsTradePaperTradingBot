...
// GetPositionSize retrieves the "position_size" value for the given userID from the MongoDB collection.
func GetPositionSize(userID int64) (float64, error) {
	...
	return tradeSetting.PositionSize, nil
}
